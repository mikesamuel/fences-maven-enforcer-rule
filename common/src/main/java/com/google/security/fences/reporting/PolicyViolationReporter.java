 ...
 * error messages.
 */
public final class PolicyViolationReporter {
  /** Receives violation reports. */
  public final Log log;
  /** Used to interpolate fences specific properties into rationales. */
  public final Interpolator interpolator;

  /**
   * @param log recieves violation reports.
   */
  public PolicyViolationReporter(Log log) {
    this.log = log;
   ...
   */
  public int report(ImmutableList<Violation> violations) {
